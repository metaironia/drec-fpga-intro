...
always @(*) begin
    case (opcode)
    `OP_IMM: {o_alu_op, o_alu_sel1, o_alu_sel2, o_cmp_op, o_branch, o_wbsel, o_jump} = {funct7[5], funct3, `ALU_SEL_1_SRC1, `ALU_SEL_2_IIMM, 3'b000, 1'b0, `WB_ALU_RES, 1'b0};
    ...
    `BRANCH: {o_alu_op, o_alu_sel1, o_alu_sel2, o_cmp_op, o_branch, o_wbsel, o_jump} = {4'b0001,           `ALU_SEL_1_BIMM, `ALU_SEL_2_PC,   funct3, 1'b1, `WB_ALU_RES, 1'b0};
    `LOAD:   {o_alu_op, o_alu_sel1, o_alu_sel2, o_cmp_op, o_branch, o_wbsel, o_jump} = {4'b0000,           `ALU_SEL_1_SRC1, `ALU_SEL_2_IIMM, 3'b000, 1'b0, `WB_ALU_RES, 1'b0};
